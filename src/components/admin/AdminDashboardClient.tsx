        ...
        <div className="p-6 lg:p-8 space-y-6 max-w-[1600px] mx-auto">
            ...
            <div className="grid grid-cols-1 xl:grid-cols-12 gap-6">
                ...
                <div className="xl:col-span-8 flex flex-col gap-6">
                    ...
                    {data.systemHealth && (
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                            <div className="bg-emerald-500/5 border border-emerald-500/20 rounded-xl p-4 flex items-center justify-between">
                                <div>
                                    <p className="text-[10px] font-medium text-emerald-400 uppercase tracking-wider">Activos (7 días)</p>
                                    <p className="text-xl font-bold text-emerald-500 mt-1">{data.systemHealth.active_last_7_days}</p>
                                </div>
                            ...
                            <div className="bg-blue-500/5 border border-blue-500/20 rounded-xl p-4 flex items-center justify-between">
                                <div>
                                    <p className="text-[10px] font-medium text-blue-400 uppercase tracking-wider">Nuevos (Semana)</p>
                                    <p className="text-xl font-bold text-blue-500 mt-1">{data.systemHealth.new_this_week}</p>
                                </div>
                            ...
                            <div className="bg-red-500/5 border border-red-500/20 rounded-xl p-4 flex items-center justify-between">
                                <div>
                                    <p className="text-[10px] font-medium text-red-400 uppercase tracking-wider">Riesgo Fuga (&gt;15d)</p>
                                    <p className="text-xl font-bold text-red-500 mt-1">{data.systemHealth.inactive_over_15_days}</p>
                                </div>
                    ...
                    {/* Restaurants Table */}
                    <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden shadow-sm flex-1">
                        ...
                        <div className="overflow-x-auto">
                            <table className="w-full text-xs">
                                <thead>
                                    <tr className="border-b border-white/5 text-neutral-500 bg-white/[0.02]">
                                    ...
                                    {data.restaurants.map(r => (
                                        <tr key={r.id} className="hover:bg-white/[0.03] transition-colors">
                                            <td className="px-5 py-3">
                                                <div className="flex items-center gap-2">
                                                    <div className="w-7 h-7 bg-gradient-to-br from-neutral-700 to-neutral-800 rounded-lg flex items-center justify-center shadow-inner">
                ...
                <div className="xl:col-span-4 flex flex-col gap-6">
                    {/* Global Communications Component */}
                    ...
                    {/* Audit Log Feed */}
                    <div className="bg-white/5 border border-white/10 rounded-xl overflow-hidden shadow-sm flex-1 flex flex-col max-h-[600px]">
                        <div className="px-5 py-4 border-b border-white/5 flex items-center justify-between">
                            <div className="flex items-center gap-2">
