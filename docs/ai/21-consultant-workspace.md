...
3. Puede ir a `/reports` para preparar un nuevo informe o revisar versiones.
4. Puede abrir `/portal` para comprobar la experiencia cliente.
5. Gestiona solicitudes de reunión enviadas desde el portal: pendiente, en revisión o completada.
6. Configura nombre, email y logo del consultor visibles en el portal cliente.
7. Consulta el histórico publicado y abre el detalle web o la vista PDF.
